...
from maia.routers.voice_router import router as voice_router
...
async def read_root(request: Request):
    return templates.TemplateResponse(request=request, name="index.html", context={"DEBUG": os.getenv("DEBUG", False)})
